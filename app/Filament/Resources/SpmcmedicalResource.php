...
use App\Filament\Resources\SpmcmedicalResource\Pages;
use pxlrbt\FilamentExcel\Actions\Tables\ExportBulkAction;
use App\Filament\Resources\SpmcmedicalResource\RelationManagers;

class SpmcmedicalResource extends Resource
{
    protected static ?string $model = Spmcmedical::class;
    protected static ?string $navigationGroup = 'Social Service';
    protected static ?string $navigationLabel = 'SPMC Medical Assistance ';
    ...
    {
        return [
            'index' => Pages\ListSpmcmedicals::route('/'),
            'create' => Pages\CreateSpmcmedical::route('/create'),
            'view' => Pages\ViewSpmcmedical::route('/{record}'),
            'edit' => Pages\EditSpmcmedical::route('/{record}/edit'),
        ];
    }
